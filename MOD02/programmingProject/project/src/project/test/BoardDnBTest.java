...
import project.game.model.Components;
...
public class BoardDnBTest {
    ...
    public void testReset() {
        ...
        assertEquals(Components.VERTICAL, board.getLine(BoardDnB.DIM));
    ...
    public void testDeepCopy() {
        board.setField(0, Components.BLUE);
        board.setField(BoardDnB.DIM * BoardDnB.DIM - 1,Components.RED);
        BoardDnB deepCopyBoard = board.deepCopy();

        // First test if all the fields are the same
        for (int i = 0; i < BoardDnB.DIM * BoardDnB.DIM; i++) {
