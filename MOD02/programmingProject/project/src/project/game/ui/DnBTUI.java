...
public class DnBTUI {
    ...
    private void run() {
        while (true) {
            ...
            if (winner == null) {
                ...
                System.out.println(game.getBoard().createBoard());
                System.out.println(
                        "WINNER: " + winner.getColour() + winner.getName() + Components.RESET);
            }
            //             allows to play another game

            System.out.println(
                    "Type \"break\" to interrupt the game, or anything else to continue");
    ...
    public static void main(String[] args) {
        ...
        //here you can choose which player will be AI by changing players
                ...
                Player player2 = new ComputerPlayer(Components.RED, new StrategyLvlHard());
