...
public abstract class SocketConnection {
    ...
    /**
     * Create a new server.SocketConnection. This is not meant to be used directly.
     * Instead, the server.SocketServer and SocketClient classes should be used.
     *
     ...
     * The receiving thread is not started yet. Call start on the returned server.SocketConnection to start receiving messages.
     *
    ...
    public void start() {
        if (started) {
            throw new IllegalStateException("Cannot start a server.SocketConnection twice");
        }
        started = true;
