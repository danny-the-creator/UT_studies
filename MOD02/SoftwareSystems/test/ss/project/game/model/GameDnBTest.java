...
public class GameDnBTest {
    ...
    public void testIsValidMove(){
        ...
        assertTrue(game.isValidMove(new MoveDnB(Components.RED, 2*game.board.DIM*(game.board.DIM+1)-1)));// the last line of the board
        assertFalse(game.isValidMove(new MoveDnB(Components.RED, 2*game.board.DIM*(game.board.DIM+1))));// the last line of the board +1
    ...
    public void testGetValidMoves(){
        ...
        assertEquals(2*game.board.DIM*(game.board.DIM+1), validMoves.size());
        for (Move move: validMoves){
            //shows that validMoves doesn't contain invalid moves
            assertNotEquals(-1,move.getLocation());
            assertNotEquals(2*game.board.DIM*(game.board.DIM+1),move.getLocation());
        }
    ...
    public void testWinner(){
        ...
        game.doMove(new MoveDnB(game.getTurn().getColour(),0));
        game.doMove(new MoveDnB(game.getTurn().getColour(),game.board.DIM));
        game.doMove(new MoveDnB(game.getTurn().getColour(),game.board.DIM+1));
        game.doMove(new MoveDnB(Components.BLUE,2*game.board.DIM+1));
    ...
    public void testGameOver(){
        for (int i=0; i<2*game.board.DIM*(game.board.DIM+1);i++ ){
    ...
    public void testDeepCopy(){
        ...
        newgame.doMove(new MoveDnB(game.getTurn().getColour(), game.board.DIM));
        assertNotEquals(game.getBoard(), newgame.getBoard());
        assertNotEquals(game.getBoard().LINES, newgame.getBoard().LINES);
    ...
    public void testGetTurn(){
        ...
        game.doMove(new MoveDnB(game.getTurn().getColour(), game.board.DIM+1));
        assertEquals(game.getTurn(), game.player2);
        game.doMove(new MoveDnB(game.getTurn().getColour(), 2*game.board.DIM+1));
