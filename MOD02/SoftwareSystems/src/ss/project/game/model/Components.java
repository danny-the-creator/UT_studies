...
public class Components {
    public static final String RED = "\u001B[31m";  //Colors the next string in Red if is added before.
    public static final String BLUE = "\u001B[36m"; //Colors the next string in Blue if is added before.
    public static final String RESET = "\u001B[0m"; //Reset the colour of the string back to White.
