...
public class ClientTUI implements ClientListener {
    ...
    private void runTUI() throws IOException, InterruptedException {
        ...
        while (!client.loggedIn) {
            ...
            if (input.equalsIgnoreCase(Protocol.LIST)) client.sendChatMessage(Protocol.LIST);
            else if (input != null) {
                client.sendUsername(input);
            }
            else { System.out.println("The username shouldn't be null, please try again");
            }
        ...
        while (true) {
            ...
            if (client.rematch){
                System.out.println("Type \"break\" to interrupt the game, or anything else to rematch");
            ...
            switch (command.toLowerCase()){
                ...
                case "queue"->{
                    ...
                    System.out.println("Write the AI level, or anything else if you want to play by yourself");
    ...
    private void help(){
        ...
        System.out.println("type 'queue' to enter the queue for the game, after that you should decide whether you want ");
        System.out.println("to play by yourself or choose a difficulty for AI (EASY/NORMAL/HARD), which will play instead of you");
