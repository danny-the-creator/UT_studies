...
import ss.project.game.model.GameDnB;
...
public class ClientHandler {
    ...
    public void handleDisconnect(){
        ...
        if (this.getPartner() != null) {
            partner.sendCHCommand(Protocol.GAMEOVER + Protocol.SEPARATOR + Protocol.DISCONNECT + Protocol.SEPARATOR + partner.getUsername());
