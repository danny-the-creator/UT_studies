...
def TP(self, y_true: np.ndarray, y_pred: np.ndarray) -> int:
...
def TN(self, y_true: np.ndarray, y_pred: np.ndarray) -> int:
...
def FP(self, y_true: np.ndarray, y_pred: np.ndarray) -> int:
...
def FN(self, y_true: np.ndarray, y_pred: np.ndarray) -> int:
...
def TPR(self, y_true: np.ndarray, y_pred: np.ndarray) -> float:
    """True positive rate."""
    tp = self.TP(y_true, y_pred)
    fn = self.FN(y_true, y_pred)
    return tp / (tp + fn)

def TNR(self, y_true: np.ndarray, y_pred: np.ndarray) -> float:
    """True negative rate."""
    tn = self.TN(y_true, y_pred)
    fp = self.FP(y_true, y_pred)
    return tn / (tn + fp)

def FPR(self, y_true: np.ndarray, y_pred: np.ndarray) -> float:
    """False positive rate."""
    fp = self.FP(y_true, y_pred)
    tn = self.TN(y_true, y_pred)
    return fp / (tn + fp)

def FNR(self, y_true: np.ndarray, y_pred: np.ndarray) -> float:
    """False negative rate."""
    fn = self.FN(y_true, y_pred)
    tp = self.TP(y_true, y_pred)
    return fn / (tp + fn)
...
#                                Visualisation                                 #
################################################################################
def prediction_report(self, y_true: np.ndarray, y_pred: np.ndarray) -> None:
...
def test_metrics(self, verbose: bool = False) -> None:
